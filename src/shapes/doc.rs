use crate::shapes::core::{Color, Geometry, Shape, Style};
...
impl<'a> Document {
    ...
    pub fn set_geometry_for_shape_id(&mut self, shape_id: &ShapeId, new_geometry: Geometry) {
        self.shapes
            .entry(*shape_id)
